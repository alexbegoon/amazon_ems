	...
	function getStatusOptions($selected = null)
	{
		// Statuses
                $statuses = array(
                    ...
                    'PEDIDO_ENGELSA_GLS',
                    'PEDIDO_ENGELSA_FEDEX',
                    'ENVIADO_GLS',
                    'ENVIADO_FEDEX',
                    'PEDIDO_ENGELSA_GLS_AQUI',
                    'PEDIDO_ENGELSA_FEDEX_AQUI',
                    'ROTURASTOCK',
                    'CANCELADO',
                    'ENVIADO_GRUTINET',
                    'ENALMACEN',
                    ...
                    'PEDIDO_ENGELSA_PACK_AQUI',
                    'ENVIADO_PACK',
                    'PREPARACION_ENGELSA_TOURLINE',
                    'PREPARACION_ENGELSA_TOURLINE_AQUI',
                    'PEDIDO_ENGELSA_TOURLINE',
                    'ENVIADO_TOURLINE',
                    'PREPARACION_FARMA_TOURLINE',
                    'PREPARACION_FARMA_TOURLINE_AQUI',
                    'PEDIDO_FARMA_TOURLINE',
                    'PTE_PAGO',
                    'PTE_ENVIO_GLS',
                    'PTE_ENVIO_FEDEX',
                    'PTE_ENVIO_PACK',
                    'PTE_ENVIO_TOURLINE',
                    'PEDIDO_ENGELSA_TOURLINE_AQUI'
                    );
                asort($statuses);
