...
<article>
    ...
    <table class="thin_table">
        ...
        <tr>
            ...
            <td title="Download order in CSV format"><a href="<?php echo base_url('index.php/providers/download_order_csv/'.$order->id);?>"><span class="csv_icon pointer_cursor"></span></a></td>
