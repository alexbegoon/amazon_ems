    ...
    <form method="POST" action="<?php echo current_url();?>" id="ajax_form">
        <table>
            <tr>
                <td>Name: </td>
                <td>
                    <input id="name" type="text" name="name" value="<?php echo $tax->name;?>" maxlength="30" required="required" />
                </td>
            </tr>
            <tr>
                <td>Percentage: </td>
                <td>
                    <input id="percent" type="text" name="percent" value="<?php echo $tax->percent;?>" maxlength="30" required="required" />
                </td>
            </tr>
            <tr>
                <td>Fixed cost per operation:</td>
                <td><input id="fixed_cost" type="text" name="fixed_cost" value="<?php echo $tax->fixed_cost;?>" maxlength="30" required="required" /></td>
            </tr>
        </table>
        <br>
