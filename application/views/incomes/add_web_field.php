<div class="edit-ajax-container">
    <?php echo form_open(current_url(), array('id' => 'ajax_form'));?>
        <table>
            <tr>
                <td>WEB</td>
                <td><input type="text" name="web" required="required" /></td>
            </tr>
            <tr>
                <td>Title</td>
            ...
            <tr>
                <td>URL</td>
                <td><input type="text" name="url" required="required" placeholder="www.mysite.com" /></td>
            </tr>
            <tr>
                <td>E-mail</td>
                <td><input type="email" name="email" required="required" placeholder="admin@admin.com" /></td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="char_set" /></td>
            </tr>
            <tr>
                <td>The character collation</td>
                <td><input type="text" name="dbcollat" /></td>
            </tr>
            <tr>
                <td>Username</td>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <?php echo get_virtuemart_versions(); ?>
                </td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                ...
                <td>
                    <input maxlength="255" id="installed_languages" type="text" placeholder="es_es, en_gb" value="" name="installed_languages" onchange="validate();" />
                </td>
            </tr>
        </table>
        <br>
