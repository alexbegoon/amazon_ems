<article>
    ...
    <div class="menu-wrapper">
        ...
        <div class="menu-item">
            <a class="menu-item-img" href="<?php echo base_url().'index.php/tracking/edit_template/it';?>">
                <img src="<?php echo base_url().'assets/imgs/flags/Italy.png';?>" alt="Edit French Email" />
            </a>
            <a class="menu-item" href="<?php echo base_url().'index.php/tracking/edit_template/it';?>">
